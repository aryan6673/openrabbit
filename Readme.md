...
Centralized companies like [CodeRabbit](https://www.coderabbit.ai/) have become "[blast-radius multipliers](https://www.endorlabs.com/blog/when-coderabbit-became-pwnedrabbit)". In late 2025, a [critical security vulnerability](https://www.propelcode.ai/blog/coderabbit-vulnerability-how-a-simple-pr-exposed-1m-repositories) in their platform exposed [over 1 million repositories](https://www.reddit.com/r/netsec/comments/1muqvkq/how_we_exploited_coderabbit_from_a_simple_pr_to/) to potential [Remote Code Execution (RCE)](https://research.kudelskisecurity.com/2025/08/19/how-we-exploited-coderabbit-from-a-simple-pr-to-rce-and-write-access-on-1m-repositories/) because users were forced to [grant broad write access](https://www.reddit.com/r/netsec/comments/1muqvkq/how_we_exploited_coderabbit_from_a_simple_pr_to/) to a third-party cloud.
...
#
![version](https://img.shields.io/badge/version-v0.4.7-orange)
